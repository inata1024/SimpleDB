...
/**
 * BTreeReverseScan is an operator which reads tuples in reversed sorted order
...
public class BTreeReverseScan implements OpIterator {
    ...
    public void reset(int tableid, String tableAlias) {
        ...
        if(ipred == null) {
            this.it = ((BTreeFile) Database.getCatalog().getDatabaseFile(tableid)).reverse_iterator(tid);
        }
        else {
